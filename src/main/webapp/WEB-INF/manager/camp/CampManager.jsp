...
<body>
	...
	<div class="container">
		<h1 style="text-align: left;" id="center">
			<a style="text-decoration: auto; " href="<%=request.getContextPath()%>/camp/CampList">
				...
				<c:forEach var="c" items="${cl}">
					<tr>
						<td><img
							...
							width="100" /></td>
						<td><a style="text-decoration: auto;" href="<%=request.getContextPath() %>/camp/CampInfo?campname=${c.campname}">${c.campname}</a></td>
						<td>${c.campaddr}</td>
						<td>${c.room}</td>
						<td>${c.payidx}</td>
						<td>
